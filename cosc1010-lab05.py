...
for mtemp in min_temps:
    if mtemp < min_temp:
        min_temp = mtemp

for xtemp in max_temps:
    if xtemp > max_temp:
        max_temp = xtemp
...
for number in numbers:
    if number > 0:
        Pos_number.append(number)
        print(f"{number} is positive.")
    elif number < 0:
        Neg_number.append(number)
        print(f"{number} is negative.")
    else:
        Zeros_number.append(number)
        print(f"{number} is equal to zero.")

pos_count = len(Pos_number)
neg_count = len(Neg_number)
zero_count = len(Zeros_number)
